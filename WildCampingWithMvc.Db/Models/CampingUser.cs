...
namespace WildCampingWithMvc.Db.Models
{
    public class DbCampingUser
    {
        ...
        private ICollection<DbCampingPlace> addedCampingPlaces;

        public DbCampingUser()
        {
            this.favoriteCampingPlaces = new HashSet<DbCampingPlace>();
            this.addedCampingPlaces = new HashSet<DbCampingPlace>();
        }
        ...
        public virtual ICollection<DbCampingPlace> AddedCampingPlaces
        {
            get
            {
