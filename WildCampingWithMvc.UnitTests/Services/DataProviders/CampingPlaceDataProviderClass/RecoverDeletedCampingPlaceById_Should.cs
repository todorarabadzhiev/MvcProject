...
{
    [TestFixture]
    public class RecoverDeletedCampingPlaceById_Should
    {
        ...
        public void CallsExactlyOnceCampingPlaceRepositoryMethodGetByIdWithCorrectArgument()
        {
            ...
            // Act
            provider.RecoverDeletedCampingPlaceById(id);
        ...
        [Test]
        public void ChangesPropertyIsDeletedOfTheFoundCampingPlaceToFalse_WhenCampingPlaceIsFound()
        {
            // Arrange
            IWildCampingEFository repository = Mock.Create<IWildCampingEFository>();
            Func<IUnitOfWork> unitOfWork = Mock.Create<Func<IUnitOfWork>>();
            ...
            // Assert
            Assert.AreEqual(false, dbPlace.IsDeleted);
        }
    }
}
